...
public class ATPVarResolver extends ELResolver {
    ...
    private static final Logger logger
            = Logger.getLogger(ATPVarResolver.class.getName());
    ...
    public Object getValue(ELContext ctx, Object base, Object property) {
        ...
        if ((base == null) && property.equals(PLAYERS)) {
            ...
            List<String> values
                    = ATPSinglesRankings.getSinglesRankings();
            return values;
        }
        return null;
    }
    ...
    @Override
    public void setValue(ELContext ctx, Object base,
        ...
        if (property == null) {
            String message
                    = MessageUtils.getExceptionMessageString(MessageUtils.NULL_PARAMETERS_ERROR_MESSAGE_ID, "property");
            throw new PropertyNotFoundException(message);
        }
    ...
    @Override
    public boolean isReadOnly(ELContext ctx, Object base,
            Object property) {
        return true;
    }
    ...
    @Override
    public Class<?> getCommonPropertyType(ELContext ctx,
            Object base) {
        if (base != null) {
            return null;
        }
